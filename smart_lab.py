...
while True :
    ...
    #                     data = inst1.read()
        ...
        #added end
        ...
        elif "runprogram" in you_removed:
            msg="ok run program"
            ...
            msg="Im your virtual lab assistant, I can control and read data from test equipments, run DAQ programs, monitoring lab status and control user devices"
            user_mentioned = True
            need_speak = True
            ...
            msg="sorry, i dont reconize that quary, please give me valid command"
            user_mentioned = False
            need_speak = True
